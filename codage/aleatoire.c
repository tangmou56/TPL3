...
void main(){
	...
	codeur_lm(n,poly1,res);

	printf("Longueur de séquence=%i\n",n);
	printf("polynôme 1 : [4,2]\npolynôme 2 : [2,1]\npolynôme 3 : [4,3,2,1]\n");
	printf("Séquance de Codeur à Longueur maximale avec polynôme 1 :\n");
	print_liste(res,nb_seq);
	printf("Séquance de Codeur de gold avec polynôme 1,2:\n");
	print_liste(res_gold,nb_seq);
	printf("Séquance de Codeur JPL avec polynôme 1,2,3:\n");
