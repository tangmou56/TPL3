...
#include "Grhom.h"
//#include "Graphe.h"
//#include "Arcol.h" //APRES Graphe.h
...
void Compiler(int nSource){
	...
	switch (nSource){
		case 0: sSource="< ( a ) C ; $";
				break;
		case 1: sSource="51 Trac ;52 Trec ; 53 Tric ; 54 Troc  ; bidule chose; 0.0 machin ; 55 Truc $";
				break;
		case 2: sSource="240317 ELLE; 0.5 elle; < elle ELLE; 0 elle; < elle ELLE; > elle ELLE ; 440317 MOI  ; 3.5 machin ; 55 Truc ;$";
				break;
		case 3: sSource="19.60 livre; 8.05 autrelivre;9.05 autre;5.05 sautre;$";
				break;
		case 4: sSource="() ; $";
				break;
		default: ;
	...
	bSucces=bSucces && bAsyntAnalyser(mAsyntGenerer); DiagnostiqueR("generatione",bSucces);
